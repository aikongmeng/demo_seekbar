...
import com.arjun.seekbar.R;

import static com.arjun.widget.SeekBar.INDICATOR_MODE_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    private Drawable progressDefaultDrawable;
...
//    private float maxPositiveValue, minPositiveValue;
    ...
    private com.arjun.widget.OnRangeChangedListener callback;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        progressDrawable = t.getDrawable(R.styleable.RangeSeekBar_rsb_progress_drawable);
        ...
        progressDefaultDrawable = t.getDrawable(R.styleable.RangeSeekBar_rsb_progress_default_drawable);
        progressHeight = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_progress_height, com.arjun.widget.Utils.dp2px(getContext(),2));
        ...
        tickMarkTextMargin = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_margin, com.arjun.widget.Utils.dp2px(getContext(),7));
        tickMarkTextSize = (int) t.getDimension(R.styleable.RangeSeekBar_rsb_tick_mark_text_size, com.arjun.widget.Utils.dp2px(getContext(),12));
        ...
        if (tickMarkTextArray != null) {
            ...
            for (int i = 0; i < tickMarkTextArray.length; i++) {
                ...
                if (tickMarkMode == TRICK_MARK_MODE_OTHER) {
                    ...
                    if (com.arjun.widget.Utils.compareFloat(num, states[0].value) != -1 && com.arjun.widget.Utils.compareFloat(num, states[1].value) != 1 && seekBarMode == SEEKBAR_MODE_RANGE) {
...
//        paint.setColor(progressDefaultColor);
        ...
        if (progressDefaultDrawable != null&&backgroundLineRect!=null) {
            progressDefaultDrawable.setBounds((int) backgroundLineRect.left, (int) backgroundLineRect.top, (int) backgroundLineRect.right, (int) backgroundLineRect.bottom);
            progressDefaultDrawable.draw(canvas);
        }
//        paint.setColor(progressColor);
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            ...
            if (progressDrawable!=null) {
                progressDrawable.setBounds((int) foregroundLineRect.left, (int) foregroundLineRect.top, (int) foregroundLineRect.right, (int) foregroundLineRect.bottom);
